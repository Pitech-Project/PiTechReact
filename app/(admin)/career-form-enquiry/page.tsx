...
export default function Page() {
  ...
  const columns: GridColDef[] = [
      ...
      { field: 'contactnumber', headerName: 'Contact Number', flex: 1, filterable: false },
      { field: 'message', headerName: 'Message', flex: 2, filterable: false },
      { field: 'appliedFor', headerName: 'Applied For', flex: 2, filterable: true },
      { field: 'appliedon', headerName: 'Applied On', flex: 2, filterable: false },
  ];
