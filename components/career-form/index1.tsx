...
export default function CarrerForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            submissionForm.append('lastname', formData.lastname);
            submissionForm.append('email', formData.email);
            submissionForm.append('contactnumber', formData.contactnumber);
            submissionForm.append('message', formData.message);
            submissionForm.append('appliedFor', formData.appliedFor || '');
            submissionForm.append('appliedon', formData.appliedon);
            if (formData.resume) submissionForm.append('resume', formData.resume);
