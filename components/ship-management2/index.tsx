                    ...
                    <Grid container spacing={10}>
                        ...
                        <Grid size={{ xs: 12, md: 6 }}>
                            <motion.div
                                ...
                                viewport={{ once: true, amount: 0.3 }}
                            >
                                    <Typography color='custom.white4' variant='body_4' display={'block'} letterSpacing={'2.4px'} textTransform={'uppercase'}>V.SHIPS | Ship Management <SmallFullStop /></Typography>
                                    <Typography marginBottom={isMdView ? '32px' : '64px'} color='custom.white5' variant='body_6' display={'block'}>Inspection Manager</Typography>
                                    <Typography color='custom.white2' margin={'16px 0 0'} display={'block'} variant='body_3'>An all-in-one communication and collaboration hub designed for seamless interaction among ship vessel crews and office personnel.</Typography>
