                    ...
                    <Grid container spacing={5} >
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Box>
                                ...
                                >
                                    <Typography marginBottom={isMdView ? '32px' : '64px'} color='custom.white5' width={'max-content'} variant='body_6' display={'block'}>The challenges<br></br>
                                        we solved</Typography>
                                </motion.div>
                            </Box>
                        </Grid>
                        <Grid size={{ xs: 12, md: 6 }}>
