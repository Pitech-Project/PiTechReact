...
import { OuterGrid, OuterSection } from '@/app/styles/MUI/common.styled';
                    ...
                    <Grid container spacing={5} alignItems={'center'}>
                        <Grid size={{ xs: 12, md: 6 }}>
                            <Box marginBottom={isMdView ? '52px' : '0'}>
                                ...
                                >
                                    <Image src={ShipManagementImg} alt='ShipManagementImg' style={{ borderRadius: '8px', width: isMdView ? '-webkit-fill-available' : 'auto', height: 'auto' }} />
                                </motion.div>
                            </Box>
                        </Grid>
                        <Grid size={{ xs: 12, md: 6 }}>
                            ...
                            >
                                <Box>
                                    <Typography marginBottom={isMdView ? '32px' : '64px'} color='custom.black' variant='body_6' display={'block'}>Accessible across web, desktop & mobile platforms</Typography>
