...
Thank you for applying for the{" "}
    <strong>{(formData.appliedFor || "position").toUpperCase()}</strong> role. We’re reviewing
    your application and will reach out if your profile aligns with the role.          </Typography>
        )}
      </Box>
    </FormUI>
  );
